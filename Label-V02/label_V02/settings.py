"""
Django settings for label_V02 project.
...
SECRET_KEY = 'django-insecure-#90@%ce5+p-$s-mj!nm(z!u@*ko5&e1h8%@o5-bka4)1yd)h-q'
...
ASGI_APPLICATION = 'label_V02.asgi.application'
...
WSGI_APPLICATION = 'label_V02.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'label_V02/static')
]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'home': {
            'handlers': ['console'],
            'level': 'INFO',  # Will always show the content in the terminal
